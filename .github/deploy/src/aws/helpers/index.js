...
exports.handleAccessIdentity = exports.getStackName = exports.getGithubRepositoryName = exports.getUrl = exports.getBranchedSubDomainName = exports.isMasterBranch = void 0;
...
const handleAccessIdentity = (scope, bucket) => {
    const cloudfrontOriginAccessIdentity = new aws_cloudfront_1.OriginAccessIdentity(scope, `${config_1.default.STACK_PREFIX}-cloud-front-origin-access-identity`);
    bucket.grantRead(cloudfrontOriginAccessIdentity);
    bucket.addToResourcePolicy(new aws_iam_1.PolicyStatement({
        actions: ['s3:GetObject'],
        resources: [bucket.arnForObjects('*')],
        principals: [new aws_iam_1.CanonicalUserPrincipal(cloudfrontOriginAccessIdentity.cloudFrontOriginAccessIdentityS3CanonicalUserId)],
    }));
